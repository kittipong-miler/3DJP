...
<!-- Sidebar end=============================================== -->
	...
	<h3> Motorcycles <small class="pull-right"> 40 products are available </small></h3>	
	<hr class="soft"/>
	<p>
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<div class="row">	  
			<div class="span2">
				<img src="themes/images/products/2.png" alt=""/>
			</div>
			<div class="span4">
				<h3>New | Available</h3>				
				<hr class="soft"/>
	...
	<div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<a href="product_details.php"><img src="themes/images/products/2.png" alt=""/></a>
				<div class="caption">
