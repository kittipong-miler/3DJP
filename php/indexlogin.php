...
<div class="tab-content">
	...
	<div class="tab-pane  active" id="blockView">
		...
		<li class="span3">
			  <div class="thumbnail">
				<a href="p5.php"><img src="themes/images/products/7.png" alt=""/></a>
				<div class="caption">
				  <h5>Trains</h5>
				  <p> 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="p7.php"><img src="themes/images/products/1.png" alt=""/></a>
				<div class="caption">
				  <h5>Vintage Cars</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="p2.php"><img src="themes/images/products/2.png" alt=""/></a>
				<div class="caption">
				  <h5>Motorcycles</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="p3.php"><img src="themes/images/products/3.png" alt=""/></a>
				<div class="caption">
				  <h5>Planes</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="p1.php"><img src="themes/images/products/4.png" alt=""/></a>
				<div class="caption">
				  <h5>Classic Cars</h5>
				  <p> 
					I'm a paragraph. Click here 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="p6.php"><img src="themes/images/products/5.png" alt=""/></a>
				<div class="caption">
				  <h5>Trucks and Buses</h5>
				  <p> 
					I'm a paragraph. Click here 
				  </p>
				    <!-- <h4 style="text-align:center"><a class="btn" href="product_details.php"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">&euro;222.00</a></h4> -->
			...
			<li class="span3">
			  <div class="thumbnail">
				<a href="p4.php"><img src="themes/images/products/6.png" alt=""/></a>
				<div class="caption">
				  <h5>Ships</h5>
				  <p> 
					I'm a paragraph. Click here 
